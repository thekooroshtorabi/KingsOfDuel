...
public class BroadcastData
{
    ...
    public override string ToString()
    {
        ...
        return String.Format("{0}:{1}:{2}:{3}:{4}:{5}:{6}::", version, peerId, isOpen ? 1 : 0, numPlayers, serverScore, privateTeamKey,Scene);
    }
...
public class Server : NetworkDiscovery
{
    ...
    public string Scene { get { return broadcastDataObject.Scene; } set { broadcastDataObject.Scene = value; } }
